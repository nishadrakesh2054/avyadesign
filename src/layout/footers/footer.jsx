...
const footer_content = {
  ...
  phone: (
    <>
      061-590648 /<br /> 9802855271
    </>
  ),
  pages_title: "Main Pages",
  pages: [
    { title: "Clubhouse", link: "/service" },
    { title: "Physiotherapy", link: "/service" },
    { title: "Tennis Court", link: "/service" },
    { title: "Group Fitness", link: "/service" },
    { title: "Gym", link: "/service" },
    { title: "Swimming Pool", link: "/service" },
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6">
                ...
                >
                  ...
                  <p>
                    {" "}
                    Subscribe to receive wellness tips, event updates, and the
                    latest club news.
                  </p>
