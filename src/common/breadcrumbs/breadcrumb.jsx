...
//         style={{ backgroundImage: `url(/assets/img/avya/contact.jpg)` }}
//       >
...
//                   <span>{title}</span>
//                 </div>
//                 <h3 className="breadcrumb__title text-light">{innertitle}</h3>
//               </div>
//             </div>
//           </div>
//         </div>
...
const Breadcrumb = ({
  title = "About",
  innertitle = "AVYA",
  backgroundImage = "/assets/img/avya/contact.jpg",
}) => {
  return (
    <>
      <section
